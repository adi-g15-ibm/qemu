...
static bool is_next_boot_mpipl = false;
    ...
    case SBE_CMD_STASH_MPIPL_CONFIG:
        ...
        switch(sbe->mbox[1]) {
            case SBE_STASH_KEY_SKIBOOT_BASE:
                ...
                qemu_log_mask(LOG_UNIMP, "Stashing skiboot base: 0x%lx\n", mpipl_skiboot_base);
                ...
                pnv_sbe_set_host_doorbell(sbe, sbe->host_doorbell | SBE_HOST_RESPONSE_WAITING);
