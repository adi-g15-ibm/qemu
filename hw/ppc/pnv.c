...
static void *pnv_dt_create(MachineState *machine)
{
    ...
    _FDT((fdt_setprop(fdt, off, "fw-load-area", fw_load_area, sizeof(fw_load_area))));
...
static void pnv_reset(MachineState *machine, ResetType type)
{
    ...
    if (pnv_sbe_is_mpipl_boot()) {
        ...
        /* @adi creating new property won't work with fdt_setprop*, use
         * fdt_appendprop, as added by https://lists.ozlabs.org/pipermail/devicetree-discuss/2011-December/010043.html */
